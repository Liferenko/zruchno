...
The same monochrome home surface renders on the device's external (cover) display, adapting to any viewport size and aspect ratio while preserving the theme.
