...
The shared visual language of the launcher: white text on a black background, apps represented only by their names, no decorative chrome, and a monospace, terminal-like aesthetic.
