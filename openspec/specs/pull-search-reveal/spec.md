...
A pull-down gesture on the app list reveals a search field pinned above the apps, letting the user filter the list by typing without leaving the home surface. The behavior works identically on the shared main and cover-display surface.
